...
- "loop_app_app": "App.tsx" | kind=code-symbol | source=loop-app/App.tsx:L1 | neighbors=[AICampusConcierge.tsx, ErrorBoundary.tsx, ErrorBoundary, EventDetailModal.tsx, NotificationModal.tsx, INITIAL_NOTIFICATIONS]
...
- "screens_queuescreen": "QueueScreen.tsx" | kind=code-symbol | source=loop-app/src/screens/QueueScreen.tsx:L1 | neighbors=[Event confidenceScore triage, App.tsx, SectionLabel.tsx, firebase.ts, auth, queue.ts]
- "screens_submitscreen": "SubmitScreen.tsx" | kind=code-symbol | source=loop-app/src/screens/SubmitScreen.tsx:L1 | neighbors=[App.tsx, FloatingField.tsx, SectionLabel.tsx, firebase.ts, auth, Props]
...
- "utils_session": "session.ts" | kind=code-symbol | source=loop-app/src/utils/session.ts:L1 | neighbors=[App.tsx, QueueScreen.tsx, SubmitScreen.tsx, firebase.ts, auth, authReady]
...
- "screens_pulsescreen": "PulseScreen.tsx" | kind=code-symbol | source=loop-app/src/screens/PulseScreen.tsx:L1 | neighbors=[App.tsx, SectionLabel.tsx, firebase.ts, pulse.ts, PulseItem, AnimatedWrapper()]
...
- "config_firebase": "firebase.ts" | kind=code-symbol | source=loop-app/src/config/firebase.ts:L1 | neighbors=[Firestore events collection (system con…, auth, firebaseConfig, App.tsx, HomeScreen.tsx, PulseScreen.tsx]
...
- "utils_vercelclient": "vercelClient.ts" | kind=code-symbol | source=loop-app/src/utils/vercelClient.ts:L1 | neighbors=[QueueScreen.tsx, SubmitScreen.tsx, geminiAI.ts, firebase.ts, auth, session.ts]
...
- "scraper_puppeteer_scraper": "puppeteer_scraper.js" | kind=code-symbol | source=loop-app/scraper/puppeteer_scraper.js:L1 | neighbors=[downloadImage(), fs, HANDLES, https, IMAGES_DIR, OUTPUT_DIR]
...
- "lib_guard": "guard.ts" | kind=code-symbol | source=api/_lib/guard.ts:L1 | neighbors=[callGemini.ts, getCloudinarySignature.ts, parseEventPoster.ts, ALLOWED_ORIGINS, Caller, guard()]
...
- "components_errorboundary_errorboundary": "ErrorBoundary" | kind=code-symbol | source=loop-app/src/components/ErrorBoundary.tsx:L16 | neighbors=[ErrorBoundary.tsx, Component, .componentDidCatch(), .getDerivedStateFromError(), .render(), App.tsx]
...
- "api_parseeventposter": "parseEventPoster.ts" | kind=code-symbol | source=api/parseEventPoster.ts:L1 | neighbors=[ALLOWED_CATEGORIES, config, handler(), guard.ts, guard()]
...
- "components_errorboundary": "ErrorBoundary.tsx" | kind=code-symbol | source=loop-app/src/components/ErrorBoundary.tsx:L1 | neighbors=[ErrorBoundary, Props, State, styles, App.tsx]
