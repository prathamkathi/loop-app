# Node Description Batch 16 of 18
...
- "deps_scraper_stack": "Scraper dependency stack (apify, firebase-admin, google-generativeai, cloudinar…" | kind=entity | source=loop-app/scraper/requirements.txt | neighbors=[Instagram → Gemini → Firestore ingestio…] | lang=en
- "lib_guard_allowed_origins": "ALLOWED_ORIGINS" | kind=code-symbol | source=api/_lib/guard.ts:L16 | neighbors=[guard.ts] | lang=en
- "lib_guard_caller": "Caller" | kind=code-symbol | source=api/_lib/guard.ts:L33 | neighbors=[guard.ts] | lang=en
- "loop_app_app_app": "App()" | kind=code-symbol | source=loop-app/App.tsx:L290 | neighbors=[App.tsx] | lang=en
- "loop_app_app_appcontent": "AppContent()" | kind=code-symbol | source=loop-app/App.tsx:L36 | neighbors=[App.tsx] | lang=en
- "loop_app_index": "index.ts" | kind=code-symbol | source=loop-app/index.ts:L1 | neighbors=[App.tsx] | lang=en
- "navigation_appnavigator_appnavigator": "AppNavigator()" | kind=code-symbol | source=loop-app/src/navigation/AppNavigator.tsx:L16 | neighbors=[AppNavigator.tsx] | lang=en
- "navigation_appnavigator_props": "Props" | kind=code-symbol | source=loop-app/src/navigation/AppNavigator.tsx:L7 | neighbors=[AppNavigator.tsx] | lang=en
...
to: /Users/prathamkathi/Downloads/LOOP/.graphify/description-instructions/batch-015.json
