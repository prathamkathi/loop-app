...
export default function TopBar({ mode, onNotification, isDark, onToggleTheme, onToggleMode, studentProfile, onOpenAuth, onOpenAI, notificationCount }: Props) {
  ...
  return <View style={[styles.bar, { backgroundColor: colors.background, borderBottomColor: colors.border }]}>
    <View style={styles.brand}>
      ...
      {!desktop && <Text style={[typography.labelSm, { color: colors.muted }]}>{mode === 'studio' ? 'Club Studio' : 'IIT Delhi'}</Text>}
    </View>
